#converting each character from ASCII to UNICODE
#Representing each character in 8 bits and removing the 0b prefix
...
#Splitting the message into chunks of 512 bits
...
#Filling the message with zeros
